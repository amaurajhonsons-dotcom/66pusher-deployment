...
class AdminSettings extends Controller {
    ...
    public function custom_images() {
        ...
        if(!empty($_POST)) {
            ...
            $images_keys = [
                ...
                'index/customizability.webp',
                'index/domains.webp',
                'index/export.webp',
                'index/flows.webp',
                'index/push_notifications.webp',
                'index/recurring_campaigns.webp',
                'index/rss_automations.webp',
                'index/segments.webp',
                'index/subscribers.webp',
                'index/widget.webp',
    ...
    public function websites() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['personal_notification_image_size_limit'] = $_POST['personal_notification_image_size_limit'] > get_max_upload() || $_POST['personal_notification_image_size_limit'] < 0 ? get_max_upload() : (float) $_POST['personal_notification_image_size_limit'];
            $_POST['rss_automation_image_size_limit'] = $_POST['rss_automation_image_size_limit'] > get_max_upload() || $_POST['rss_automation_image_size_limit'] < 0 ? get_max_upload() : (float) $_POST['rss_automation_image_size_limit'];
            $_POST['recurring_campaign_image_size_limit'] = $_POST['recurring_campaign_image_size_limit'] > get_max_upload() || $_POST['recurring_campaign_image_size_limit'] < 0 ? get_max_upload() : (float) $_POST['recurring_campaign_image_size_limit'];
            $_POST['branding'] = trim($_POST['branding']);
            $_POST['pwas_is_enabled'] = (int) isset($_POST['pwas_is_enabled']);

            $value = json_encode([
                'pwas_is_enabled' => $_POST['pwas_is_enabled'],
                ...
                'personal_notification_image_size_limit' => $_POST['personal_notification_image_size_limit'],
                'rss_automation_image_size_limit' => $_POST['rss_automation_image_size_limit'],
                'recurring_campaign_image_size_limit' => $_POST['recurring_campaign_image_size_limit'],

                'campaigns_notifications_per_cron' => (int) $_POST['campaigns_notifications_per_cron'],
                'campaigns_notifications_per_cron_loop' => (int) $_POST['campaigns_notifications_per_cron_loop'],
                'campaigns_notifications_per_cron_loop_sent' => (int) $_POST['campaigns_notifications_per_cron_loop_sent'],
                'flows_notifications_per_cron' => (int) $_POST['flows_notifications_per_cron'],
                'personal_notifications_per_cron' => (int) $_POST['personal_notifications_per_cron'],
