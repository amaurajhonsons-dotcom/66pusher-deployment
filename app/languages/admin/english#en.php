...
return [
    ...
    'admin_plans.plan.pwas_limit' => 'PWAs limit',
    'admin_plans.plan.subscribers_limit' => 'Subscribers limit',
    'admin_plans.plan.personal_notifications_limit' => 'Personal notifications limit',
    'admin_plans.plan.personal_notifications_limit_help' => 'Personal notifications are single notifications sent for 1 subscriber only. Useful for testing, API usage or dedicated notifications.',
    'admin_plans.plan.rss_automations_limit' => 'RSS automations limit',
    'admin_plans.plan.rss_automations_limit_help' => 'RSS automations are used to automatically parse RSS feeds and send notifications to subscribers.',
    ...
    'admin_plans.plan.sent_push_notifications_per_month_limit' => 'Sent push notifications',
    'admin_plans.plan.domains_limit' => 'Custom domains limit',
    'admin_plans.plan.subscribers_logs_retention' => 'Subscribers logs retention',
    'admin_plans.plan.subscribers_logs_retention_help' => 'How many days will the subscriber logs be kept in the database.',
    ...
    'admin_plans.plan.custom_branding_is_enabled' => 'Custom branding',
    'admin_plans.plan.custom_branding_is_enabled_help' => 'This gives the option for people to set their own custom branding to the branded resources.',
   ...
   'admin_settings.facebook.tab' => 'Facebook login',
    ...
    'admin_settings.cron.campaigns' => 'Campaigns - push notifications cron job',
    'admin_settings.cron.flows' => 'Flows - push notifications cron job',
    'admin_settings.cron.personal_notifications' => 'Personal notifications - push notifications cron job',
    'admin_settings.cron.rss_automations' => 'RSS automations - push notifications cron job',
    'admin_settings.cron.recurring_campaigns' => 'Recurring campaigns - push notifications cron job',
    ...
    'admin_settings.websites.tab' => 'Websites',
    'admin_settings.websites.service_worker_file_name' => 'Service worker file name',
    'admin_settings.websites.service_worker_file_name_help' => '',
    'admin_settings.websites.pixel_cache' => 'Pixel cache',
    'admin_settings.websites.pixel_cache_help' => 'Set 0 to disable the cache of the pixel code.',
    'admin_settings.websites.pixel_exposed_identifier' => 'Pixel exposed identifier',
    'admin_settings.websites.pixel_exposed_identifier_help' => 'The pixel identifier is used in different places related to the pixel JS code.',
    'admin_settings.websites.email_notices_is_enabled' => 'Send email on plan limit reached',
    'admin_settings.websites.email_notices_is_enabled_help' => 'Send emails to your users when their campaigns / push notifications per month plan limit reached.',
    'admin_settings.websites.pwas_is_enabled' => 'Enable the PWA generation system',
    'admin_settings.websites.pwas_is_enabled_help' => 'Enabling this will give your users the ability to create & manage custom PWAs for their websites.',
    'admin_settings.websites.domains_is_enabled' => 'Enable the Custom Domains system',
    'admin_settings.websites.domains_is_enabled_help' => 'Enabling this will give your users the ability to add and use custom domains.',
    'admin_settings.websites.domains_custom_main_ip' => 'IP of your server',
    'admin_settings.websites.domains_custom_main_ip_help' => 'The IP that will be displayed when adding a custom domain. Leave empty to show the default detected server IP.',
    'admin_settings.websites.blacklisted_domains' => 'Blacklisted domains',
    'admin_settings.websites.blacklisted_domains_help' => 'People will not be able to submit any URL domain that is included in this list. Comma separated values of domains.',
    'admin_settings.websites.icon_size_limit' => 'Websites icon size limit',
    'admin_settings.websites.campaign_image_size_limit' => 'Campaigns image size limit',
    'admin_settings.websites.flow_image_size_limit' => 'Flow image size limit',
    'admin_settings.websites.personal_notification_image_size_limit' => 'Personal notification image size limit',
    'admin_settings.websites.rss_automation_image_size_limit' => 'RSS automation image size limit',
    'admin_settings.websites.recurring_campaign_image_size_limit' => 'Recurring campaign image size limit',
    'admin_settings.websites.branding' => 'Branding',
    'admin_settings.websites.branding_help' => 'This branding is used by default in the website widgets. HTML can be used in this field.',
    'admin_settings.websites.file_size_limits' => 'Upload file size limits',
    'admin_settings.websites.campaigns_notifications_per_cron' => 'Campaigns - total sent notifications per cron run',
    'admin_settings.websites.campaigns_notifications_per_cron_loop' => 'Campaigns - sent notifications per cron loop in one run',
    'admin_settings.websites.campaigns_notifications_per_cron_loop_sent' => 'Campaigns - sent notifications at once per cron loop',
    'admin_settings.websites.flows_notifications_per_cron' => 'Flow - total sent notifications per cron run',
    'admin_settings.websites.personal_notifications_per_cron' => 'Personal notifications - total sent notifications per cron run',
    'admin_settings.websites.rss_automations_per_cron' => 'RSS automations - total RSS automations checks per cron run',
    'admin_settings.websites.recurring_campaigns_per_cron' => 'Recurring campaigns - total recurring campaigns checks & scheduling per cron run',
    ...
    'admin_pwas.title' => 'PWAs',
    'admin_pwas.header' => 'PWAs',
    'admin_pwas.menu' => 'PWAs',
    ...
    'admin_personal_notifications.title' => 'Personal notifications',
    'admin_personal_notifications.header' => 'Personal notifications',
    'admin_personal_notifications.menu' => 'Personal notifications',
    ...
    'admin_subscribers.title' => 'Subscribers',
    'admin_subscribers.header' => 'Subscribers',
    'admin_subscribers.menu' => 'Subscribers',


    'admin_subscribers_logs.title' => 'Subscribers logs',
    'admin_subscribers_logs.header' => 'Subscribers logs',
    'admin_subscribers_logs.menu' => 'Subscribers logs',
];
