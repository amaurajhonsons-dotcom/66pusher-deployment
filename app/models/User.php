...
class User extends Model {
    ...
    public function create(
        ...
        $preferences = json_encode([
            ...
            'subscribers_default_order_by' => 'subscriber_id',
            'subscribers_logs_default_order_by' => 'subscriber_log_id',
            'campaigns_default_order_by' => 'campaign_id',
            'personal_notifications_default_order_by' => 'personal_notification_id',
