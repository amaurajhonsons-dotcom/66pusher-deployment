...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="rss_automation_update" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select id="website_id" name="website_id" class="form-control <?= \Altum\Alerts::has_field_errors('website_id') ? 'is-invalid' : null ?>" required="required">
                        <?php foreach($data->websites as $website): ?>
                            <option value="<?= $website->website_id ?>" <?= $data->rss_automation->website_id == $website->website_id ? 'selected="selected"' : null ?>><?= $website->name . ' - ' . $website->host . $website->path ?></option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group" data-character-counter="input">
                    ...
                    <input type="text" id="title" name="title" class="form-control <?= \Altum\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" value="<?= $data->rss_automationa->title ?>" maxlength="64" required="required" />
                ...
                <div class="form-group" data-character-counter="input">
                    ...
                    <input type="text" id="description" name="description" value="<?= $data->rss_automation->description ?>" class="form-control <?= \Altum\Alerts::has_field_errors('description') ? 'is-invalid' : null ?>" maxlength="128" required="required" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="url" name="url" value="<?= $data->rss_automation->url ?>" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" />
                        ...
                        <?php if (!empty($data->segments)): ?>
                            <optgroup label="<?= l('campaigns.segment.saved') ?>">
                                <?php foreach($data->segments as $segment): ?>
                                    <option value="<?= $segment->segment_id ?>" <?= $data->rss_automation->segment == $segment->segment_id ? 'selected="selected"' : null ?> data-website-id="<?= $segment->website_id ?>"><?= $segment->name ?></option>
                                <?php endforeach ?>
                            </optgroup>
                        <?php endif ?>
                    </select>
                ...
                <div class="collapse" data-parent="#rss_automation_update" id="buttons_container">
                    ...
                    <div class="p-3 bg-gray-50 rounded mb-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="button_title_1" name="button_title_1" class="form-control <?= \Altum\Alerts::has_field_errors('button_title_1') ? 'is-invalid' : null ?>" value="<?= $data->rss_automation->settings->button_title_1 ?>" maxlength="16" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="button_url_1" name="button_url_1" class="form-control <?= \Altum\Alerts::has_field_errors('button_url_1') ? 'is-invalid' : null ?>" value="<?= $data->rss_automation->settings->button_url_1 ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" />
                    ...
                    <div class="p-3 bg-gray-50 rounded mb-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="button_title_2" name="button_title_2" class="form-control <?= \Altum\Alerts::has_field_errors('button_title_2') ? 'is-invalid' : null ?>" value="<?= $data->rss_automation->settings->button_title_2 ?>" maxlength="16" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="button_url_2" name="button_url_2" class="form-control <?= \Altum\Alerts::has_field_errors('button_url_2') ? 'is-invalid' : null ?>" value="<?= $data->rss_automation->settings->button_url_2 ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" />
                ...
                <div class="collapse" data-parent="#rss_automation_update" id="utm_container">
                    <div class="form-group">
                        <label for="utm_source"><i class="fas fa-fw fa-sitemap fa-sm text-muted mr-1"></i> <?= l('campaigns.utm_source') ?></label>
                        <input id="utm_source" type="text" class="form-control" name="utm_source" value="<?= $data->rss_automation->settings->utm->source ?? '' ?>" maxlength="128" placeholder="<?= l('campaigns.utm_source_placeholder') ?>" />
                    </div>

                    <div class="form-group">
                        <label for="utm_medium"><i class="fas fa-fw fa-inbox fa-sm text-muted mr-1"></i> <?= l('campaigns.utm_medium') ?></label>
                        <input id="utm_medium" type="text" class="form-control" name="utm_medium" value="<?= $data->rss_automation->settings->utm->medium ?? '' ?>" maxlength="128" placeholder="<?= l('campaigns.utm_medium_placeholder') ?>" />
                    </div>

                    <div class="form-group">
                        <label for="utm_campaign"><i class="fas fa-fw fa-bullhorn fa-sm text-muted mr-1"></i> <?= l('campaigns.utm_campaign') ?></label>
                        <input id="utm_campaign" type="text" class="form-control" name="utm_campaign" value="<?= $data->rss_automation->settings->utm->campaign ?? '' ?>" maxlength="128" placeholder="<?= l('campaigns.utm_campaign_placeholder') ?>" />
                    </div>
                ...
                <div class="collapse" data-parent="#rss_automation_update" id="advanced_container">
                    <div class="form-group custom-control custom-switch">
                        <input id="is_silent" name="is_silent" type="checkbox" class="custom-control-input" <?= $data->rss_automation->settings->is_silent ? 'checked="checked"' : null?>>
                    ...
                    <div class="form-group custom-control custom-switch">
                        <input id="is_auto_hide" name="is_auto_hide" type="checkbox" class="custom-control-input" <?= $data->rss_automation->settings->is_auto_hide ? 'checked="checked"' : null?>>
                    ...
                    <div class="form-group">
                        ...
                        <select id="ttl" name="ttl" class="form-control <?= \Altum\Alerts::has_field_errors('ttl') ? 'is-invalid' : null ?>" required="required">
                            <?php foreach($data->notifications_ttl as $key => $value): ?>
                                <option value="<?= $key ?>" <?= $data->rss_automation->settings->ttl == $key ? 'selected="selected"' : null ?>><?= $value ?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="urgency" name="urgency" class="form-control <?= \Altum\Alerts::has_field_errors('urgency') ? 'is-invalid' : null ?>" required="required">
                            <?php foreach(['low', 'normal', 'high'] as $key): ?>
                                <option value="<?= $key ?>" <?= $data->rss_automation->settings->urgency == $key ? 'selected="selected"' : null ?>><?= l('campaigns.urgency.' . $key) ?></option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="collapse" data-parent="#rss_automation_update" id="rss_container">
                    <div class="form-group">
                    ...
                    <div class="form-group custom-control custom-switch">
                        <input id="use_rss_image" name="use_rss_image" type="checkbox" class="custom-control-input" <?= $data->rss_automation->settings->use_rss_image ? 'checked="checked"' : null?>>
...
/* UTM */
    ...
    let get_segment_count = async () => {
        ...
        if(segment == 'filter') {
            query = new URLSearchParams(new FormData(document.querySelector('#rss_automation_update')));
        }
