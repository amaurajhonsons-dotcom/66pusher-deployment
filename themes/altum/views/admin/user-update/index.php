        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="subscribers_limit" name="subscribers_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->subscribers_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="sent_push_notifications_per_month_limit" name="sent_push_notifications_per_month_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->sent_push_notifications_per_month_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="personal_notifications_limit"><?= l('admin_plans.plan.personal_notifications_limit') ?></label>
                    <input type="number" id="personal_notifications_limit" name="personal_notifications_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->personal_notifications_limit ?>" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="pwas_limit" name="pwas_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->pwas_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                <?php endif ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="subscribers_logs_retention" name="subscribers_logs_retention" min="-1" class="form-control" value="<?= $data->user->plan_settings->subscribers_logs_retention ?>" />
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="custom_branding_is_enabled" name="custom_branding_is_enabled" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->custom_branding_is_enabled ? 'checked="checked"' : null ?>>
