        ...
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <optgroup label="<?= l('admin_settings.general') ?>">
                    ...
                    <option value="<?= url('admin/settings/websites') ?>" <?= $data->method == 'websites' ? 'selected="selected"' : null ?>>🌍 <?= l('admin_settings.websites.tab') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'websites' ? 'active' : null ?>" href="<?= url('admin/settings/websites') ?>"><i class="fas fa-fw fa-sm fa-pager mr-2"></i> <?= l('admin_settings.websites.tab') ?></a>
