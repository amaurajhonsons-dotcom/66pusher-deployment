    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/subscribers') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="subscribers">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="subscribers_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold">
                            <?= l('campaigns.total_sent_push_notifications') ?>
                        </small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/campaigns') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="total_sent_push_notifications">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="sent_push_notifications_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
        ...
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold">
                            <i class="fas fa-fw fa-sm fa-globe mr-1"></i> <?= l('admin_domains.menu') ?>
                        </small>
                    </div>
                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
    ...
    'use strict';
        ...
        (async function fetch_statistics() {
            ...
            if(data.status == 'error') {
                ...
                document.querySelector('#subscribers').innerHTML = data.details.subscribers ? nr(data.details.subscribers) : 0;
                document.querySelector('#subscribers_current_month').innerHTML = data.details.subscribers_current_month ? nr(data.details.subscribers_current_month) : 0;
                ...
                document.querySelector('#total_sent_push_notifications').innerHTML = data.details.total_sent_push_notifications ? nr(data.details.total_sent_push_notifications) : 0;
                document.querySelector('#sent_push_notifications_current_month').innerHTML = data.details.sent_push_notifications_current_month ? nr(data.details.sent_push_notifications_current_month) : 0;
